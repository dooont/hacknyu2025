...
use solana_program_solana_client::{accounts::Counter, instructions::CreateBuilder};
...
#[tokio::test]
async fn create() {
    let mut context = ProgramTest::new("solana_program_solana", solana_program_solana_client::ID, None)
        .start_with_context()
        .await;
